...
public class DepartmentController {
    ...
    //워크스페이스별 부서목록 조회
    @GetMapping("/workspace/{workspaceId}/department/list")
    ...
    //회원이 속한 워크스페이스 부서 목록
    @GetMapping("/workspace/{workspaceId}/department/member-department-list")
    public ResponseEntity<List<Department>> getDepartmentListByWorkspaceAndMember(@PathVariable String workspaceId, @RequestParam("email") String email){
